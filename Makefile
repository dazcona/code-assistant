...
create:
	...
	docker exec -it web python src/create.py data/predictions/predictions_CA116_2019_week_11.json
	docker exec -it web python src/create.py data/recommendations/recommendations_CA116_2019_week_11.json
send:
